...
PROJ_MODES=("no_head" "head_on_hfeat" "head_on_zfeat")

for MODE in "${PROJ_MODES[@]}"; do
    echo "Running SimCLR with projection mode ${MODE}"
    EXP_NAME="${DATASET}_${BACKBONE}_abl_proj_${MODE}"
