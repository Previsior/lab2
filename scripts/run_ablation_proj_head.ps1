...
$projModes = @("no_head", "head_on_hfeat", "head_on_zfeat")

foreach ($mode in $projModes) {
    Write-Host "Running SimCLR with projection mode $mode"
    $expName = "${dataset}_${backbone}_abl_proj_$mode"
